        ...
        .upsert([
            {
                ...
                country: country,
                region: region,
                image_url: image ? `${process.env.VITE_SUPABASE_URL}/storage/v1/object/public/ccbuild/${image.name}` : null,
                ...
                <div className=" border p-3">
                    <form className="form-inline col" onSubmit={handleSubmit}>
                        ...
                        <div className="mb-5" id="description">
                            ...
                            <textarea className="form-control" id="exampleFormControlTextarea1" rows="3" style={{height: '100px'}} value={description}onChange={(e) => setDescription(e.target.value)}></textarea>
                        </div>

                        <div className="row mb-5">
                        <div className=" col">
                            <label htmlFor="">Eget projektnummer</label>
                            <input type="text" className="form-control" id="project_number" placeholder="Eget projektnummer" value={project_number}onChange={(e) => setProject_Number(e.target.value)}></input> 
                        </div>
                        <div className=" col">
                            <label htmlFor="">Organistaion</label>
                            <select className="form-select" id="orgianization" value={organization}onChange={(e) => setOrganization(e.target.value)}>
                                <option defaultValue={'Sverige'}>Utbildningskonto - Yrgo</option>
                        ...
                        <div className=" mb-3 col">
                            ...
                            <input type="text" className="form-control" id="" placeholder="Eget projektnummer" value={location_1}onChange={(e) => setLocation1(e.target.value)}></input>
                        </div>
                        <div className=" mb-3 col">
                            <label htmlFor="">Platsbenämning #2</label>
                            <input type="text" className="form-control" id="" placeholder="Eget projektnummer" value={location_2}onChange={(e) => setLocation2(e.target.value)}></input>
                        </div>
                        </div>
                        ...
                        <div className=" mb-3 col">
                            ...
                            <input type="text" className="form-control" id="" placeholder="Eget projektnummer" value={location_3}onChange={(e) => setLocation3(e.target.value)}></input>
                        </div>
                        <div className=" mb-3 col">
                            <label htmlFor="">Platsbenämning #4</label>
                            <input type="text" className="form-control" id="" placeholder="Eget projektnummer" value={location_4}onChange={(e) => setLocation4(e.target.value)}></input>
                        </div>
                        </div>

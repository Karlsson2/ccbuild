...
export default function ItemsLoopFormDropdown({ formData, setFormData }) {
  ...
  return (
    <>
      <Container
        className="bg-gray br-8 hover-pointer p-4 mt-4 mb-4"
        onClick={toggleExpansion}
      >
        <Row className="d-flex justify-content-center">
          <Col>
            <h2>Hantering för marknadsplats</h2>
          </Col>
          <Col xs="auto">
            <img
              src={arrowUp}
              alt="Arrow Up"
              height={40}
              className={`d-flex justify-content-end arrow-up ${
                isExpanded ? "expanded" : ""
              }`}
        ...
        <Container md={8} className="bg-gray br-8 p-4">
            ...
            <Col>
              <Form.Group>
                ...
                <Form.Control
                  type="number"
                  name="external_price"
                  value={formData.external_price ? formData.external_price : ""}
                  onChange={handleInputChange}
                  placeholder="Pris"
                />
              </Form.Group>
            ...
            <Col>
              <Form.Group>
                ...
                <Form.Control
                  type="number"
                  name="internal_price"
                  value={formData.internal_price ? formData.internal_price : ""}
                  placeholder="Pris"
                />
              </Form.Group>
            </Col>
            <Col className="d-flex align-items-end mb-2">
              <Form.Group>
                <Form.Check
                  ...
                  name="suggest_price"
                  checked={
                    formData.suggest_price ? formData.suggest_price : false
                  }
                  onChange={handleInputChange}
                />
              </Form.Group>
            ...
            <Col>
              <Form.Group>
                ...
                <Form.Control
                  type="text"
                  name="post_city"
                  value={formData.post_city ? formData.post_city : ""}
                  onChange={handleInputChange}
          ...
          <Form.Group>
            ...
            <Form.Control
              type="text"
              name="manufacturer"
              value={formData.manufacturer ? formData.manufacturer : ""}
              onChange={handleInputChange}
          ...
          <Form.Group className="mt-4">
            ...
            <Form.Control
              type="text"
              name="article_number"
              value={formData.article_number ? formData.article_number : ""}
              onChange={handleInputChange}
            ...
            <Col>
              <Form.Group>
                ...
                <Form.Control
                  type="number"
                  name="manufacturing"
                  value={formData.manufacturing ? formData.manufacturing : ""}
                  onChange={handleInputChange}
            ...
            <Col>
              <Form.Group>
                ...
                <Form.Control
                  type="number"
                  name="purchase_year"
                  value={formData.purchase_year ? formData.purchase_year : ""}
                  onChange={handleInputChange}
            ...
            <Col>
              <Form.Group>
                ...
                <Form.Control
                  type="text"
                  name="rsk"
                  value={formData.rsk ? formData.rsk : ""}
                  onChange={handleInputChange}
            ...
            <Col>
              <Form.Group>
                ...
                <Form.Control
                  type="text"
                  name="enr"
                  value={formData.enr ? formData.enr : ""}
                  onChange={handleInputChange}
                  placeholder="Relevant för elektronik och VVS"
                />
              </Form.Group>
            ...
            <Col>
              <Form.Group>
                ...
                <Form.Control
                  type="text"
                  name="bsab"
                  value={formData.bsab ? formData.bsab : ""}
                  onChange={handleInputChange}
            ...
            <Col>
              <Form.Group>
                ...
                <Form.Control
                  type="text"
                  name="bkfour"
                  value={formData.bkfour ? formData.bkfour : ""}
                  onChange={handleInputChange}
                  placeholder="Ange BSAB-kod om känt/relevant. Används för att underlätta klass"
                />
              </Form.Group>
